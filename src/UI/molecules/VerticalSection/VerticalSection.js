...
export const VerticalSection = ({ children = DefaultChildren, ...rest }) => (<Box display='flex' flexDirection='column' alignItems='center' maxWidth={MAX_CONTENT_WIDTH} width='100%' gap={GAP} {...rest}>{children}</Box>)