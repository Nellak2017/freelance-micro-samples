...
export const HomeFirstCard = ({ aspectRatio, children, ...rest }) => (<Box component='article' display='flex' alignItems='center' justifyContent='center' width='100%' minWidth='130px' overflow='hidden' position='relative' borderRadius={GAP} boxShadow={GAP} {...rest}>{children}</Box>)
